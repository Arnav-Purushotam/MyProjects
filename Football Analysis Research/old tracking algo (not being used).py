...
#Reading the video
vidcap = cv2.VideoCapture(r'C:\Users\Asus\Desktop\football AR\raw football videos\FULL MATCH_ BARÇA 5-0 MADRID (2010) 👋.mp4')
		...
		if(h>=(1.5)*w):
			if(w>15 and h>= 15):
				...
				if(nzCount >= 20):
					...
					cv2.putText(image, 'Barca', (x-2, y-2), font, 0.8, (255,0,0), 2, cv2.LINE_AA)
					cv2.rectangle(image,(x,y),(x+w,y+h),(255,0,0),3)
				else:
					pass
				if(nzCountred>=20):
					#Mark red jersy players as belgium
					cv2.putText(image, 'Real', (x-2, y-2), font, 0.8, (0,0,255), 2, cv2.LINE_AA)
